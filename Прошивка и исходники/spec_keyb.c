...
const flash unsigned short decodeE_std[decodeSize] = {
  ...
  193,192,205,144,0,140,0,0,145,432,192,135,157,
  ...
  131,0,129,133,129,0,0,131,132,136,130,193,160
};
...
134,221,220,217,216,215,214,213,212,211,210,209,208,
8192,4096,0,145,204,201,200,199,198,197,196,195,194,
193,192,205,144,0,140,0,0,145,432,192,135,189,
...
// НАДО ПЕРЕМЕНСТИ РУЧКАМИ В ТАБЛИЦУ ПРЕРЫВАНИЙ!
...
.EQU PORTB = $18
        ...
        ; DDRB = c2b[PINC]; 
        IN   R28, PINC            ; 1 3
        ANDI R28, 0x3F            ; +1   Нужна только при включенном RESET
        CPI  R28, 0x3F            ; 1 4
